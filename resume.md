...
I was asked to join the Outware team to help solve some directional problems they where having with their build environments. This required working with one of their major clients ANZ to find a solution that would meet both ANZ and Outware requirements for a build environment. One of the immediate problems was that due to software restrictions on OSX which is required to compile IOS apps we where limited to how many virtual machines could run on hardware and that the hardware had to be supplied by Apple. We also had restrictions to the type of CI being used and poor performance from the preselected vitalization that had been selected.
</p>
</div>
<div class="job">
<h2>Geoplex</h2>
